        ...
        <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-20">
          <div className="max-w-2xl mx-auto px-4 text-center">
            <div className="bg-green-50 border-2 border-green-200 rounded-xl p-12">
              ...
              <a
                href="/"
                className="inline-block px-8 py-3 bg-gradient-to-r from-blue-500 to-amber-500 text-white rounded-full font-semibold hover:shadow-lg transition-all"
              >
                Return Home
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <h2 className="text-3xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-amber-500 bg-clip-text text-transparent">
                Send Us a Message
              </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full py-4 bg-gradient-to-r from-blue-500 to-amber-500 text-white rounded-full font-bold text-lg hover:shadow-xl transform hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center flex-shrink-0 mr-4">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="space-y-3">
                  ...
                  <a
                    href="/services"
                    className="block text-center px-6 py-3 bg-gray-100 text-gray-700 rounded-full font-semibold hover:bg-gray-200 transition-all"
                  >
                    View Services
                  </a>
                  <a
